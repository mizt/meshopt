...
typedef int (*FILTER)(std::vector<float> *, std::vector<unsigned int> *, NSString *);
...
int main(int argc, char *argv[]) {
  ...
  int pluginPass = 1;
  NSString *pluginPath = @"../meshopt.plugin";
  CFStringRef pluginFunctionName = (__bridge CFStringRef)(@"meshopt");
  NSString *pluginParams = @"{\"si\":0.5}";
